...
type Args struct {
	Entity string         `json:"entity" jsonschema:"breed | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TheCatSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "the-cat_list",
		Description: "List records from TheCat. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "the-cat_load",
		Description: "Load a single record from TheCat. " +
...
func runOp(client *sdk.TheCatSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TheCatSDK, name string) (sdk.TheCatEntity, error) {
	switch strings.ToLower(name) {
	case "breed":
		return client.Breed(nil), nil
	case "search":
