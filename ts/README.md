# TheCat TypeScript SDK



The TypeScript SDK for the TheCat API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Breed()` — each with a small set of operations (`list`)
...
```ts
const client = new TheCatSDK({ apikey: '...' })
...
| `tester(testopts?, sdkopts?)` | `TheCatSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `TheCatSDK.test(testopts?, sdkopts?)` | `TheCatSDK` | Create a test-mode client. |
...
| `client` | `client(): TheCatSDK` | Return the parent SDK client. |
