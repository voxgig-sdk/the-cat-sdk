# TheCat TypeScript SDK Reference

Complete API reference for the TheCat TypeScript SDK.
...
#### `TheCatSDK.test(testopts?, sdkopts?)`
...
**Returns:** `TheCatSDK` instance in test mode.
...
Return the parent `TheCatSDK` instance.
