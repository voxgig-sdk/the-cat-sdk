...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/the-cat` | `npm install @voxgig-sdk/the-cat` |
| Python | `voxgig-sdk-the-cat` | `pip install voxgig-sdk-the-cat` |
| PHP | `voxgig-sdk/the-cat` | `composer require voxgig-sdk/the-cat` |
| Golang | `github.com/voxgig-sdk/the-cat-sdk/go` | `go get github.com/voxgig-sdk/the-cat-sdk/go` |
| Ruby | `voxgig-sdk-the-cat` | `gem install voxgig-sdk-the-cat` |
| Lua | `voxgig-sdk-the-cat` | `luarocks install voxgig-sdk-the-cat` |
