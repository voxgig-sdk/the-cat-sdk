...
Learn more about The Cat API at [thecatapi.com](https://thecatapi.com).
...
| Go CLI | `github.com/voxgig-sdk/the-cat-sdk/go-cli` | `go install github.com/voxgig-sdk/the-cat-sdk/go-cli/cmd/the-cat@latest` |
| Go MCP server | `github.com/voxgig-sdk/the-cat-sdk/go-mcp` | `go get github.com/voxgig-sdk/the-cat-sdk/go-mcp@latest` |
