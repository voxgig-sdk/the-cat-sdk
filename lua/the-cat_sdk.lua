...
TheCatSDK._make_feature = _make_feature


function TheCatSDK.new(options)
  local self = setmetatable({}, TheCatSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TheCatSDK:options_map()
...
function TheCatSDK:get_utility()
  return Utility.copy(self._utility)
end


function TheCatSDK:get_root_ctx()
  return self._rootctx
end


function TheCatSDK:prepare(fetchargs)
...
function TheCatSDK:direct(fetchargs)
...
-- by passing it.
function TheCatSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TheCatSDK:graphql(query, variables, ctrl)
...
function TheCatSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TheCatSDK.new(sdkopts)
  sdk.mode = "test"
