...
describe("BreedDirect", function()
  it("should direct-list-breed", function()
    local setup = breed_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-breed", setup.live and "live" or "unit")
...
function breed_direct_setup(mockres)
