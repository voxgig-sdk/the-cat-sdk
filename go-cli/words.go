...
func registerSDKWords(r *eng.Registry, client *sdk.TheCatSDK) {
...
func runOp(client *sdk.TheCatSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
