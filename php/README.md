...
The PHP SDK for the TheCat API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Breed(null)->list(null, null);
...
[$result, $err] = $client->TheCat(null)->load(
    ["id" => "test01"], null
);
