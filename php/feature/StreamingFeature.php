...
class TheCatStreamingFeature extends TheCatBaseFeature
{
    ...
    private function _iterate(TheCatResult $result): \Generator
    {
    ...
    private function _streamable(TheCatContext $ctx): bool
    {
