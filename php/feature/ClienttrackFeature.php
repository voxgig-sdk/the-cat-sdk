...
// TheCat SDK clienttrack feature
...
class TheCatClienttrackFeature extends TheCatBaseFeature
{
    ...
    public function PostConstruct(TheCatContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TheCat-SDK';
