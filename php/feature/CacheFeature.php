...
class TheCatCacheFeature extends TheCatBaseFeature
{
    ...
    private function _through(TheCatContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
