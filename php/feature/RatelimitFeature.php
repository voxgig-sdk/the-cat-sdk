...
class TheCatRatelimitFeature extends TheCatBaseFeature
{
    ...
    private function _acquire(TheCatContext $ctx): void
    {
    ...
    private function _track(TheCatContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
