...
// TheCat SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TheCatSDK::test)
...
{
    private const SDK_CLASS = 'TheCatSDK';
    ...
    private const SDK_BASE = 'thecat_sdk';
