...
class BreedDirectTest extends TestCase
{
    public function test_direct_list_breed(): void
    {
        $setup = breed_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-breed", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
