...
// TheCat SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TheCatMakeRequest
{
    public static function call(TheCatContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TheCatResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TheCatResponse($fetched);
        } else {
