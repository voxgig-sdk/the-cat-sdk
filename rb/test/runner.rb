...
module TheCatTestRunner
  ...
  def self.env_override(m)
    live = getenv("THECAT_TEST_LIVE")
    override = getenv("THECAT_TEST_OVERRIDE")
    ...
    explain = getenv("THECAT_TEST_EXPLAIN")
    m["THECAT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
