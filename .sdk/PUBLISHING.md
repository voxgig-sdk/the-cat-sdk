...
|---|---|---|
| `ts/` | @voxgig-sdk/the-cat-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/the-cat-sdk \
      --repository voxgig-sdk/the-cat-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/the-cat-sdk` shows it, and
`npm trust revoke @voxgig-sdk/the-cat-sdk --id=<id>` removes it.
