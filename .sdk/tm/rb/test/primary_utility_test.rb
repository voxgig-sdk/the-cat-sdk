...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = TheCatOmni.make_runner(TEST_JSON_FILE, TheCatSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : TheCatOmni.errify(err)
    end
