...
class TheCatTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TheCatTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TheCatTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TheCatTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
