...
class TheCatTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TheCatTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TheCatTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TheCatTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
