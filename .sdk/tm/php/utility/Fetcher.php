...
class TheCatFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TheCatSDK/1.0)';
    ...
    public static function call(TheCatContext $ctx, string $fullurl, array $fetchdef): array
    {
