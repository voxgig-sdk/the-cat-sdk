...
class TheCatTimeoutFeature extends TheCatBaseFeature
{
    ...
    private function _with_timeout(TheCatContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TheCatContext $_ctx, float $ms): void
    {
        $client = $this->client;
