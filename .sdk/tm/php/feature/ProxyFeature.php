...
class TheCatProxyFeature extends TheCatBaseFeature
{
    ...
    public function init(TheCatContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TheCatContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
