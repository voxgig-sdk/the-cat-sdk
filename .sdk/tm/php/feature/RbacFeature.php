...
class TheCatRbacFeature extends TheCatBaseFeature
{
    ...
    private function _required(TheCatContext $ctx): ?string
    {
    ...
    private function _reject(TheCatContext $ctx, string $required): void
    {
    ...
    private function _track(TheCatContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
