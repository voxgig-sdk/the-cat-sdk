...
// TheCat SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TheCatTestFeature extends TheCatBaseFeature
{
    ...
    public function init(TheCatContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TheCatContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TheCatContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TheCatContext $ctx, $op, $args): array
    {
