...
class TheCatTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TheCatTestRunner.getenv("THECAT_TEST_LIVE")
        override = TheCatTestRunner.getenv("THECAT_TEST_OVERRIDE")
        ...
        explain = TheCatTestRunner.getenv("THECAT_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["THECAT_TEST_EXPLAIN"] = explain
