...
from thecat_sdk.core.spec import TheCatSpec
from thecat_sdk.core.result import TheCatResult
from thecat_sdk.core.response import TheCatResponse
from thecat_sdk.core.operation import TheCatOperation
from thecat_sdk.core.error import TheCatError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = TheCatSDK.test(None, None)
        ...
        class TestInitFeature(TheCatBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TheCatBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TheCatSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TheCatSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TheCatSDK.test(None, setup_opts)
