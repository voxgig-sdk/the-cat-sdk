# TheCat SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TheCatSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TheCatSDK(...) and TheCatSDK.test(...) become
#      TheCatSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "thecat_sdk"
_SDK_CLASS = "TheCatSDK"
