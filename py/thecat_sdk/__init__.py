...
from thecat_sdk.utility import register

# Load features
from thecat_sdk.feature.base_feature import TheCatBaseFeature
from thecat_sdk.features import _has_feature, _make_feature
...
class TheCatSDK:
    ...
    def get_utility(self):
        return TheCatUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TheCatSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Breed(self, data=None) -> "BreedEntity":
        ...
        from thecat_sdk.entity.breed_entity import BreedEntity
        return BreedEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from thecat_sdk.entity.search_entity import SearchEntity
