...
from thecat_sdk.core.control import TheCatControl
...
from thecat_sdk.core.helpers import get_ctx_prop, to_map
...
class TheCatContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TheCatResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TheCatError(code, msg, self)
