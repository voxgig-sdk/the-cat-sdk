...
func TestBreedEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set THECAT_TEST_BREED_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func breedBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("THECAT_TEST_BREED_ENTID")
	...
	idmapResolved := core.ToMapAny(env["THECAT_TEST_BREED_ENTID"])
