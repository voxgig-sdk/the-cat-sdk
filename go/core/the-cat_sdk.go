...
func (sdk *TheCatSDK) OptionsMap() map[string]any {
...
func (sdk *TheCatSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TheCatSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TheCatSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TheCatSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TheCatSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TheCatSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TheCatSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TheCatSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TheCatSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TheCatSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
